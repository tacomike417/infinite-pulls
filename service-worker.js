...
const CACHE = 'infinite-pulls-v158';   // v158: Infinite Feed title, full-circle app icon, no tabs on profiles.   // v157: a card in the profile grid opens their post over the profile.   // v156: card tiles open the card's page; rewards tab shows only earned cards + what was done.   // v155: $ on card tiles, EARNED + how-to-earn on reward tiles.   // v154: profile tabs -- cards, ∞ rewards, wish list, posts.   // v153: Instagram-style profile, Edit profile, real following with EVERYONE / FOLLOWING.   // v152: scan-to-follow QR codes.   // v151: @ search finds people, with card counts.   // v150: @handles in the feed.
const CORE = [
